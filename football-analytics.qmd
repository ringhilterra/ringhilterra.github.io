...
::: {.football-profile}
::: {.football-profile-photo}
![](headshot.JPEG){fig-alt="Ryan Inghilterra headshot"}

::: {.football-contact}
[Email](mailto:ringhilterra17@gmail.com){.football-contact-btn}
[Website](https://ringhilterra.github.io/){.football-contact-btn}
[LinkedIn](https://www.linkedin.com/in/ryan-inghilterra-017/){.football-contact-btn .secondary}
:::
:::

::: {.football-profile-main}
::: {.football-current}
::: {.football-current-item}
Role
